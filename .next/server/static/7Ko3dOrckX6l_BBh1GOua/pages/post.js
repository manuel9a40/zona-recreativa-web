...
const Page = () => {
  ...
  return __jsx(_components_GeneralLayout__WEBPACK_IMPORTED_MODULE_2__["default"], null, __jsx("h1", null, router.query.title), __jsx("p", null, "This is the blog post content."));
};
