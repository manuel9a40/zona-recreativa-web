...
const Timeline = props => console.log(props.info) || props.info.length > 0 && __jsx("div", {
  ...
  __self: undefined
}, props.info.map((data, idx) => __jsx(_TimelineItem__WEBPACK_IMPORTED_MODULE_2__["default"], {
  data: data,
  key: idx,
  __source: {
    fileName: _jsxFileName,
...
/* harmony import */ var _data_infoPackage_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../data/infoPackage.json */ "./pages/data/infoPackage.json");
var _data_infoPackage_json__WEBPACK_IMPORTED_MODULE_6___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../data/infoPackage.json */ "./pages/data/infoPackage.json", 1);
/* harmony import */ var _components_Timeline__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/Timeline */ "./pages/components/Timeline.js");
...
const Post = props => {
  if (props.errorCode) {
    ...
    __self: undefined
  }, "Itinerario"), __jsx(_components_Timeline__WEBPACK_IMPORTED_MODULE_7__["default"], {
...
Post.getInitialProps = async function (context) {
  ...
  for (var i = 0; i < _data_infoPackage_json__WEBPACK_IMPORTED_MODULE_6__.length; i++) {
    if (typeof _data_infoPackage_json__WEBPACK_IMPORTED_MODULE_6__[i].id !== 'undefined' && _data_infoPackage_json__WEBPACK_IMPORTED_MODULE_6__[i].id == infoPkg) {
      var result = _data_infoPackage_json__WEBPACK_IMPORTED_MODULE_6__[i]; // console.log(result)
...
/***/ "./pages/style/timeline-style.css":
/*!****************************************!*\
  !*** ./pages/style/timeline-style.css ***!
  \****************************************/
/*! no static exports found */
...
/***/ 4:
/*!*******************************************!*\
  !*** multi ./pages/pPackage/[infoPkg].js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/nano/Documents/AdmProyecto/zona-recreativa-web/pages/pPackage/[infoPkg].js */"./pages/pPackage/[infoPkg].js");
