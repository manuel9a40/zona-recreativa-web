...
class Album extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getSelectedImages() {
    ...
    for (var i = 0; i < this.state.images.length; i++) if (this.state.images[i].isSelected == true) selected.push(i);
  ...
  render() {
    return __jsx("div", {
      ...
      __self: this
    }, __jsx(react_grid_gallery__WEBPACK_IMPORTED_MODULE_2___default.a, {
...
Album.propTypes = {
  images: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.shape({
    ...
    srcset: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array,
    caption: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
    thumbnailWidth: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number.isRequired,
    thumbnailHeight: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number.isRequired,
...
/* harmony import */ var _components_Album__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/Album */ "./pages/components/Album.js");
...
const album = props => {
  ...
  return __jsx("div", {
    ...
    __self: undefined
  }, __jsx(_components_Album__WEBPACK_IMPORTED_MODULE_7__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 20
    },
...
/***/ 3:
/*!***************************************!*\
  !*** multi ./pages/pAlbum/[album].js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/nano/Documents/AdmProyecto/zona-recreativa-web/pages/pAlbum/[album].js */"./pages/pAlbum/[album].js");
