...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(context) {
    var album, errorCode, i, result;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            album = context.query.album; //
            // return { infoPkg };
          ...
          case 3:
            ...
            if (!(typeof _data_photos_json__WEBPACK_IMPORTED_MODULE_8__[i].id !== 'undefined' && _data_photos_json__WEBPACK_IMPORTED_MODULE_8__[i].id == album)) {
              _context.next = 7;
              break;
            }
...
//# sourceMappingURL=[album].js.e5e4bd39f246b63fbb51.hot-update.js.map